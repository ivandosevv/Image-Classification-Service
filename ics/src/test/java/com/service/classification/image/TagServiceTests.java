...
import com.service.classification.image.service.impl.JpaTagServiceImpl;
...
public class TagServiceTests {
    ...
    void testGetTagByIdReturnsProperTag() {
        ...
        Assertions.assertEquals(from, service.getTagById(id));
    ...
    void testGetTagByNameReturnsProperTag() {
        ...
        Assertions.assertEquals(from, service.getTagByName(name));
    ...
    void testGetTagWithValidSetReturnsCorrectImages() {
        ...
        Assertions.assertEquals(from, service.get(tagSet).get(firstIndex));
    ...
    void testAddTagWithValidParametersChecksIfItExists() {
        ...
        Assertions.assertEquals(this.service.addTag(from), from);
    }
